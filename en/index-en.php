...
<section class="about-section">
    <div class="container">
        <div class="heading-container text-center">
            <h2>About <span>TECHART Company</span></h2>
            <p>
                TECHART Foreign Language Translation Services Sole Company Limited was established legally under the Enterprise Law No. 46/NA, dated 26/12/2013 and the Publishing Law No. 05/NA, dated 09/12/2008. Operating under the supervision of the Ministry of Information, Culture and Tourism and the regulations of the Lao PDR issued periodically. Our company is a leading provider of document translation, review, and certification services for foreign languages, supported by a team with over 5 years of experience and advanced degrees (Master's and above).
            </p>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="image-box">
                    <img src="../img/about.png" alt="About TECHART Company">
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="details-box">
                    <p>
                        <strong>Vision:</strong> To be a trusted company providing satisfying document and foreign language translation services to our clients.
                    </p>
                    <p>
...
<div class="my-container">
    ...
    <div class="my-customer-grid">
        <div class="my-customer-item">
            <img src="../img/1.png" alt="Charoen Sekong Carbon">
        </div>
        <div class="my-customer-item">
            <img src="../img/2.png" alt="Thanok Wangkao Tha Tok Company">
        </div>
        <div class="my-customer-item">
            <img src="../img/3.png" alt="Houng Aloun HAL EXPRESS">
        </div>
        <div class="my-customer-item">
            <img src="../img/4.png" alt="Thanok Wangkao Tha Tok LPY Company">
        </div>
        <div class="my-customer-item">
            <img src="../img/5.png" alt="CS ENERGY">
        </div>
        <div class="my-customer-item">
            <img src="../img/6.png" alt="Luay Huay Galaxy 18">
        </div>
        <div class="my-customer-item">
        ...
        <div class="my-customer-item">
            <img src="../img/15.png" alt="The World Bank">
        </div>
    </div>
</div>
